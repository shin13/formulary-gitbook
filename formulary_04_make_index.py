...
# 使用 os.path.join 來處理文件路徑，確保跨平台兼容性
excel_file = os.path.join(os.getcwd(), 'formulary2.xlsx')
...
# Write the index to index1.md
output_file = os.path.join(os.getcwd(), 'index1.md')
